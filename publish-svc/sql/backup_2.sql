...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='系统角色定义';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `roles` VALUES (1,'admin','管理员','Administrator','系统最高权限，管理用户、角色、配置',1,'2025-10-08 07:24:29'),(2,'developer','开发','Developer','开发人员，具备开发与部署相关权限',1,'2025-10-08 07:24:29'),(3,'tester','测试','Tester','测试人员，具备测试环境与用例管理权限',1,'2025-10-08 07:24:29'),(4,'project_manager','项目经理','Project Manager','项目管理与资源调度权限',1,'2025-10-08 07:24:29'),(5,'operator','操作员','Operator','一线操作人员，具备生产运行相关权限',1,'2025-10-08 07:24:29'),(6,'process_engineer','工艺','Process Engineer','工艺工程师，负责工艺参数与流程维护',1,'2025-10-08 07:24:29');
...
CREATE TABLE `users` (
  ...
  `nickname` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '昵称',
  ...
  `status` enum('active','inactive') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'active' COMMENT '状态：active-启用, inactive-停用',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`),
...
-- Dump completed on 2025-10-08 15:51:37
