...
from app.api.v1 import auth, facilities, interfaces, bindings, deployment, logs, exe, publish
...
api_router.include_router(publish.router, prefix="/publish", tags=["发布业务"])
